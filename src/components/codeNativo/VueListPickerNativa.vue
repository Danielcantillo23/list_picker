    ...
    <div class="vue-list-picker">
      ...
      <div class="list-picker-actions">
        <button @click="moveAllRight" :class="buttonClass">
          <img v-if="!$slots.moveAllRight" src="../assets/chevrons-right.37a67009" alt="Chevrons right">
          <slot name="moveAllRight"/>
        </button>
        <button @click="moveRight" class="mb-25" :class="buttonClass">
          <img v-if="!$slots.moveRight" src="../assets/chevron-right.48712edb" alt="Chevron right">
          <slot name="moveRight"/>
        </button>
        <button @click="moveLeft" :class="buttonClass">
          <img v-if="!$slots.moveLeft" src="../assets/chevrons-left.a388069a" alt="Chevron left">
          <slot name="moveLeft"/>
        </button>
        <button @click="moveAllLeft" class="mb-25" :class="buttonClass">
          <img v-if="!$slots.moveAllLeft" src="../assets/chevron-left.5b886670" alt="Chevrons left">
          <slot name="moveAllLeft"/>
        </button>
        <button @click="unselectAll" :class="buttonClass">
          <img v-if="!$slots.unselectAll" src="../assets/logo.png" alt="X icon">
